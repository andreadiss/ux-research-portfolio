...
const AI_CASE_STUDIES = [
  createCaseStudy({
    id: 'ai-1',
    title: 'AI in the Web Experience',
    featured: true,
    category: 'AI',
    methodologies: {
      type: 'Qualitative',
    ...
    subtitle: 'Making AI features clear, useful, and easy to adopt',
    context: 'Sky redesigned its website and introduced an AI agent to simplify how users understand and explore its TV and WiFi offering. The experience aimed to guide users through content discovery and pricing, while supporting decision-making.',
    challenge: 'The challenge was ensuring users recognized the AI agent role, trusted it, and used it effectively to support decision-making. The goal was 0 friction with this feature.',
    ...
    insights: 'The AI agent was recognized and valued, but its impact was limited by a lack of conversational clarity and unified experience, reducing its full potential as a decision-support tool.',
    impact: 'Research led to repositioning the AI agent as a unified entry point, increasing its visibility and expected adoption, and reducing drop-offs during the decision journey.',
    visuals: [
